...
plt.tight_layout()
plt.savefig("resnet18_confusion_matrix.png", bbox_inches="tight")
plt.show()

# =========================
# SAVE MODEL
# =========================
torch.save(model.state_dict(), "resnet18_gtsrb_transfer.pth")
print("Model saved as: resnet18_gtsrb_transfer.pth")